...
<header class="hero">
  <div class="wrap">
    ...
    <h1>Never miss a call again.<br><span class="grad">30 exclusive leads a month — yours alone.</span></h1>
    ...
    <div class="floaters">
      ...
      <div class="fcard fc5"><div class="n">14-DAY MONEY-BACK</div><div class="l">No leads in 2 weeks = full refund. No forms, no fights.</div></div>
    </div>
  </div>
</header>
...
<section class="stats reveal"><div class="wrap"><div class="stats">
  ...
  <div class="stat"><div class="v"><span class="cnt" data-to="50" data-prefix="~" data-suffix="%">0</span></div><div class="l">of jobs go to whoever answers first</div></div>
  <div class="stat"><div class="v"><span class="cnt" data-to="20" data-prefix="$">0</span></div><div class="l">per qualified lead — yours alone</div></div>
  <div class="stat"><div class="v"><span class="cnt" data-to="30" data-prefix="~">0</span></div><div class="l">exclusive leads a month</div></div>
  <div class="stat"><div class="v"><span class="cnt" data-to="9">0</span></div><div class="l">services in the Full Stack</div></div>
  <div class="stat"><div class="v"><span class="cnt" data-to="0" data-prefix="$">0</span></div><div class="l">setup fee — cancel anytime</div></div>
  <div class="stat"><div class="v"><span class="cnt" data-to="14">0</span></div><div class="l">day money-back: no leads in 2 weeks = refund</div></div>
  <div class="stat"><div class="v"><span class="cnt" data-to="65" data-prefix="~" data-suffix="%">0</span></div><div class="l">cheaper than Angi's $300+/mo plans</div></div>
  <div class="stat"><div class="v"><span class="cnt" data-to="24" data-suffix="/7">0</span></div><div class="l">answered — nights, weekends, holidays</div></div>
  <div class="stat"><div class="v"><span class="cnt" data-to="50" data-suffix="%">0</span></div><div class="l">off when you stack 3+ services</div></div>
  <div class="stat"><div class="v"><span class="cnt" data-to="5">0</span></div><div class="l">days from signup to live</div></div>
  <div class="stat"><div class="v">$45–228</div><div class="l">Google's typical price per lead</div></div>
</div></div></section>
